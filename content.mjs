...
export const STEPS = [
    ...
    task(0, 'platform-layers', 'order', '留影功法',
        '天機鏡欲施展「留影功法」，攝下城門之景。此招共分三式，由起念到成形，依序為何？請由第 1 式排至第 3 式。',
        [
            ['app', '預言程式（應用程式）：下達「留影」之令'],
            ['os', '作業系統：接令，調度鏡頭與處理器'],
            ['hardware', '鏡頭與處理器（硬體）：催動法器，攝下城景']
        ], ['app', 'os', 'hardware'], 3, ['招式先有發令之人，法器才會動。', '預言程式不能親手催動法器，須經中間那一式。']),
