...
- 根目錄 `/`：**修改建議版**，49 步、31 個作答關卡。改了用詞（簡體字、大陸用語、宗教或恐懼意味較重的詞），新增 12 關，每關 3 分、最後一關 10 分；課程名稱暫定「數位修真錄」。
- `/original/`：**目前正式版**，37 步、19 個作答關卡、每關 5 分，和 KUSU 上現在的文字相同。
- `/changes.html`：**修改對照**，列出新增的關卡，以及每一處用詞修改前、修改後與原因。

原本 19 關的題目、選項與答案在兩個版本相同。
